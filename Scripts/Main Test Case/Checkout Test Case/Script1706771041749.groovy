...
WebUI.callTestCase(findTestCase('Common Test Case/Login Test Case'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_firstName'), 'Rudi')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_lastName'), 'Suhendra')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_postalCode'), '17456')
...
WebUI.callTestCase(findTestCase('Common Test Case/Logout Test Case'), [:], FailureHandling.STOP_ON_FAILURE)
