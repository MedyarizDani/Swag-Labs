...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_firstName'), 'Maulana')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_lastName'), 'Ibrahim')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_postalCode'), '178980')
